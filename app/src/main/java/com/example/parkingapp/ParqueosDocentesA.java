...
public class ParqueosDocentesA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pronostico.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ParqueosDocentesA.this.getApplicationContext(), Estimacion.class);// New activity
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(ParqueosDocentesA.this.getApplicationContext(), Docentes.class);// New activity
                Bundle extras = new Bundle();
                extras.putString("usuarioId", userId + "");
                intent.putExtras(extras);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
    ...
    public void confirmacionReserva(String userId,String horaInicio,String horaFinal,String horaid,String parqueoId){
        Intent intent = new Intent(ParqueosDocentesA.this.getApplicationContext(), ConfirmacionReserva.class);// New activity
        Bundle extras = new Bundle();
        extras.putString("usuarioId", userId + "");
    ...
    public void mandarinfoReserva(String userId,String horaInicio,String horaFinal,String horaid,String parqueoId,int reservaId){
        Intent intent = new Intent(ParqueosDocentesA.this.getApplicationContext(), InfoReserva.class);// New activity
        Bundle extras = new Bundle();
        extras.putString("usuarioId", userId + "");
        extras.putString("horaInicio", horaInicio + "");
        extras.putString("horaFinal", horaFinal + "");
    ...
    public void mandarinfoConductor(String userId,String horaInicio,String horaFinal,String horaid,String parqueoId,String userId1){
        Intent intent = new Intent(ParqueosDocentesA.this.getApplicationContext(), InfoConductor.class);// New activity
        Bundle extras = new Bundle();
        extras.putString("usuarioId", userId + "");
