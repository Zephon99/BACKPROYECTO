...
public class Lot2 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String>adapter = new ArrayAdapter<String>(Lot2.this,
        ...
        ArrayAdapter<String>adapter1 = new ArrayAdapter<String>(Lot2.this,
                android.R.layout.simple_spinner_item,horas);
        ...
        reserva.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Lot2.this.getApplicationContext(), ParqueosDocentesA.class);// New activity
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Lot2.this.getApplicationContext(), Docentes.class);// New activity
                Bundle extras = new Bundle();
                extras.putString("usuarioId", userID + "");
                intent.putExtras(extras);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
